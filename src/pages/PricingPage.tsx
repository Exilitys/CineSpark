      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mt-4">
            Credits are consumed when using AI features. Story and shot list modifications use the same credits as generation. Unused credits roll over each month for Pro and Enterprise plans.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-400">Credits are consumed when using AI features like story generation (10 credits), shot list creation (15 credits), and storyboard generation (20 credits). Modifications use the same amount as initial generation.</p>
            </div>
            <div>
