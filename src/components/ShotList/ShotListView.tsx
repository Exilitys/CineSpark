              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span
                      className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${getSceneColor(
                        shot.scene_number || 1
                      )}`}
                    >
                      {shot.scene_number || 1}
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  <span
                    className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${getShotTypeColor(
                      shot.shot_type
                    )}`}
                  >
                    {shot.shot_type}
                ...
                <p className="text-xs text-gold-400 line-clamp-1">
                  {shot.lens_recommendation}
                </p>
                {shot.notes && (
